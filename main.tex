...
\centering
\includegraphics[width=.7\linewidth]{figs/flatness_a.png}
\end{minipage}
\begin{minipage}{0.4\linewidth}
\centering
\includegraphics[width=.7\linewidth]{figs/flatness_b.png}
\end{minipage}
...
We derive an AMP loss from the empirical risk (ERM loss). Minimizing such an AMP loss can penalize the sharp minima by adversarially perturbing the model parameters.\\
\vspace{-0.5em}
\begin{equation*}
